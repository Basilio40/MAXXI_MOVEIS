...
orcamento_patterns = [
    ...
    path('detail1/<int:pk>/', v.OrcamentoDetailView.as_view(), name='orcamento_detail_ent'),  # noqa E501
    ...
    path('delete/<int:pk>/', v.orcamento_delete, name='orcamento_delete'),  
    ...
    path('orc_entrega/',v.ListEntrega.as_view(), name='orc_entrega'),
    path('entrega_create/<int:pk>/',v.orc_entrega_create, name='orc_entrega_create'),
]
